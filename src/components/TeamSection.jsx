            ...
            <div className="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:px-8 lg:py-24">
                <div className="space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0">
                    ...
                    <div className="lg:col-span-2">
                        <ul
                            role="list"
                            className="space-y-12 sm:-mt-8 sm:space-y-0 sm:divide-y sm:divide-secondary-200 lg:gap-x-8 lg:space-y-0"
                        >
                            {people.map((person) => (
                                        ...
                                        <div className="sm:col-span-2">
                                            <div className="space-y-4">
                                                ...
                                                <div className="text-lg">
                                                    <p className="text-secondary-500">{person.bio}</p>
                                                </div>
                                                <ul role="list" className="flex space-x-5">
                                                    <li>
                                                        <a href={person.twitterUrl} className="text-secondary-400 hover:text-secondary-500">
                                                    ...
                                                    <li>
                                                        <a href={person.linkedinUrl} className="text-secondary-400 hover:text-secondary-500">
